...
import { namedNode as namedNode$1 } from '@rdfjs/data-model';
...
var ShexFormModel = /** @class */ (function () {
    ...
    ShexFormModel.prototype.getNumberConstraint = function (exp, fieldTerm) {
        ...
        isNaN(maxValue)
            ? false
            : this.graph.addQuad(this.getSubjectNode(fieldTerm.id), namedNode$1(NS_UI + "maxValue"), this.jsonLdtoRdf({ value: maxValue }));
        isNaN(minValue)
            ? false
            : this.graph.addQuad(this.getSubjectNode(fieldTerm.id), namedNode$1(NS_UI + "minValue"), this.jsonLdtoRdf({ value: minValue }));
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        validatedField[UI.VALUE] = isType ? namedNode$1(currentField.value) : currentField.value;
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, data[parent_1[UI.BASE]][parent_1[UI.PARENT_PROPERTY]].add(namedNode$1(parent_1[UI.VALUE]))];
                    case 6:
                        _b.sent();
            ...
            function findField(nodeName, model) {
                var _loop_2 = function (fieldKey) {
                    ...
                    if (currentField[UI.NAME] === nodeName) {
                        ...
                        var parts = cloneDeep(currentField[UI.CLONE_PARTS][copiedField]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, data[field[UI.BASE]][field[UI.PARENT_PROPERTY]].delete(namedNode$1(field[UI.VALUE]))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: 
...
export { FormActions, FormModel, ShexFormModel, formUi, n3Helpers as n3Helper };
