...
class ActorRdfResolveQuadPatternSparqlJson extends bus_rdf_resolve_quad_pattern_1.ActorRdfResolveQuadPattern {
    ...
    static patternToCountQuery(pattern) {
        return sparqlalgebrajs_1.toSparql(ActorRdfResolveQuadPatternSparqlJson.FACTORY.createProject(ActorRdfResolveQuadPatternSparqlJson.FACTORY.createExtend(ActorRdfResolveQuadPatternSparqlJson.FACTORY.createGroup(ActorRdfResolveQuadPatternSparqlJson.patternToBgp(pattern), [], [ActorRdfResolveQuadPatternSparqlJson.FACTORY.createBoundAggregate(data_model_1.variable('var0'), 'count', ActorRdfResolveQuadPatternSparqlJson.FACTORY.createWildcardExpression(), false)]), data_model_1.variable('count'), ActorRdfResolveQuadPatternSparqlJson.FACTORY.createTermExpression(data_model_1.variable('var0'))), [data_model_1.variable('count')]));
    }
    async test(action) {
    ...
    async run(action) {
        ...
        const metadata = () => this.queryBindings(endpoint, countQuery, action.context)
            .then((bindingsStream) => new Promise((resolve, reject) => {
