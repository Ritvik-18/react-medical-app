...
export declare abstract class LinkedRdfSourcesAsyncRdfIterator extends BufferedIterator<RDF.Quad> implements RDF.Stream {
    ...
    private started;
    private iterating;
    constructor(cacheSize: number, subject: RDF.Term | undefined, predicate: RDF.Term | undefined, object: RDF.Term | undefined, graph: RDF.Term | undefined, firstUrl: string, options?: BufferedIteratorOptions);
    /**
