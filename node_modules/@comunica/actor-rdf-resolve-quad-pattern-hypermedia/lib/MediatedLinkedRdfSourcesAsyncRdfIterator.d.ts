...
export declare class MediatedLinkedRdfSourcesAsyncRdfIterator extends LinkedRdfSourcesAsyncRdfIterator {
    ...
    constructor(cacheSize: number, context: ActionContext, forceSourceType: string | undefined, subject: RDF.Term | undefined, predicate: RDF.Term | undefined, object: RDF.Term | undefined, graph: RDF.Term | undefined, firstUrl: string, mediators: IMediatorArgs);
