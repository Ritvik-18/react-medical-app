...
export declare abstract class ActorRdfResolveQuadPatternSource extends ActorRdfResolveQuadPattern {
    ...
    static variableToUndefined(term: RDF.Term | undefined): RDF.Term | undefined;
    /**
     ...
     */
    protected getMetadata(source: ILazyQuadSource, pattern: RDF.BaseQuad, context: ActionContext | undefined, data: AsyncIterator<RDF.Quad> & RDF.Stream): () => Promise<{
        [id: string]: any;
    }>;
    /**
