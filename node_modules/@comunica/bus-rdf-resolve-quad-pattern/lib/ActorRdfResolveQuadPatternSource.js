...
class ActorRdfResolveQuadPatternSource extends ActorRdfResolveQuadPattern_1.ActorRdfResolveQuadPattern {
    ...
    static variableToUndefined(term) {
    ...
    async getOutput(source, pattern, context) {
        ...
        let data;
        if (source.matchLazy) {
            data = source.matchLazy(ActorRdfResolveQuadPatternSource.variableToUndefined(pattern.subject), ActorRdfResolveQuadPatternSource.variableToUndefined(pattern.predicate), ActorRdfResolveQuadPatternSource.variableToUndefined(pattern.object), ActorRdfResolveQuadPatternSource.variableToUndefined(pattern.graph));
        }
        else {
            data = asynciterator_1.wrap(source.match(ActorRdfResolveQuadPatternSource.variableToUndefined(pattern.subject), ActorRdfResolveQuadPatternSource.variableToUndefined(pattern.predicate), ActorRdfResolveQuadPatternSource.variableToUndefined(pattern.object), ActorRdfResolveQuadPatternSource.variableToUndefined(pattern.graph)));
        }
