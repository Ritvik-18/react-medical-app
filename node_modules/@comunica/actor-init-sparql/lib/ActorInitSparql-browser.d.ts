...
import { IActionQueryOperation, IActorQueryOperationOutput, IActorQueryOperationOutputBindings, IActorQueryOperationOutputQuads, IActorQueryOperationOutputBoolean } from '@comunica/bus-query-operation';
import { IActionSparqlParse, IActorSparqlParseOutput } from '@comunica/bus-sparql-parse';
import { IActionSparqlSerializeHandle, IActionSparqlSerializeMediaTypeFormats, IActionSparqlSerializeMediaTypes, IActorOutputSparqlSerializeHandle, IActorOutputSparqlSerializeMediaTypeFormats, IActorOutputSparqlSerializeMediaTypes, IActorSparqlSerializeOutput, IActorTestSparqlSerializeHandle, IActorTestSparqlSerializeMediaTypeFormats, IActorTestSparqlSerializeMediaTypes } from '@comunica/bus-sparql-serialize';
...
export declare class ActorInitSparql extends ActorInit implements IActorInitSparqlArgs {
     ...
     */
    getResultMediaTypeFormats(context?: ActionContext): Promise<{
        [id: string]: string;
    }>;
    /**
