...
import { Bindings, BindingsStream } from './Bindings';
/**
...
export declare abstract class ActorQueryOperation extends Actor<IActionQueryOperation, IActorTest, IActorQueryOperationOutput> {
     ...
     */
    static cachifyMetadata<T extends (() => Promise<{
        [id: string]: any;
    }>) | (undefined | (() => Promise<{
        [id: string]: any;
    }>))>(metadata: T): T;
 ...
 * @return The metadata.
 */
export declare function getMetadata(actionOutput: IActorQueryOperationOutputStream): Promise<{
    [id: string]: any;
}>;
/**
